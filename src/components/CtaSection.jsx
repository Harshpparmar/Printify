    ...
    return (
        <section className="py-16">
            <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                ...
                >
                    <div className="block text-center mb-5 lg:text-left font-noto lg:mb-0">
                    <h2
                    ...
                    <a
                    href="#"
                    className="flex items-center gap-2 bg-white rounded-full shadow-sm text-lg text-green-600 font-noto font-semibold py-4 px-8 transition-all duration-500"
                    >Talk to sales
